...
#
    ...
    erg1 = np.linspace(0.0, ni1*delta1,ni1)
    erg2 = np.linspace(0.0, ni2*delta2,ni2)
...
#    s = re.sub('[\[\]]', '', s)
#    s = re.sub('\n ', ' \n', s)
    s = leapr2xml.five_columns(new_rho)
...
#        s = re.sub('[\[\]]', '', s)
#        s = re.sub('\n ', ' \n', s)
        s = leapr2xml.five_columns(new_skappa)
