...
available_models = {"HH2O-ENDF6":"xml/hh2o-endf6.xml", "HH2O-ENDF7":"xml/hh2o-endf7.xml", "DD2O-ENDF7":"xml/dd2o-endf7.xml"}
...
if __name__ == '__main__':
  ...
  leapr_input = basename + ".leapr"
  nout = leapr_interpolator.getnout(available_models[model_choice])

  if (dbg >= 1):
    print ">>> Creating the input by interpolation"
  leapr_interpolator.leapr_interpolator(available_models[model_choice], leapr_input, temp)
